        ...
        <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner" style="height:400px;">
            ...
            <div class="carousel-item active h-100">
              <img src="{{ asset('images/hero/slide3.jpg') }}" class="d-block w-100 h-100" style="object-fit: cover;"
                alt="Slide 1">
            </div>
            <!-- Slide 2 -->
            <div class="carousel-item h-100">
              <img src="{{ asset('images/hero/slide2.jpg') }}" class="d-block w-100 h-100" style="object-fit: cover;"
                alt="Slide 2">
            </div>
            <!-- Slide 3 -->
            <div class="carousel-item h-100">
              <img src="{{ asset('images/hero/slide1.jpg') }}" class="d-block w-100 h-100" style="object-fit: cover;"
                alt="Slide 3">
            </div>
          </div>
